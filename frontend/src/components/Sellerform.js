...
import styles from '../styles/SellerForm.css';
...
const SellerformSelect = () => {
  ...
  return (
    <>
      <div className={styles.sellerformSelect}>
        <div className={styles.headerParent}>
          <div className={styles.header}>
            <div className={styles.titleFormParent}>
              <div className={styles.titleForm}>
                <div className={styles.input}>
                  <div className={styles.div}>라이브 방송 제목</div>
                </div>
              </div>
            ...
            <img className={styles.thumbnailIcon} alt="" src="Thumbnail.png" />
        ...
        <div className={styles.button}>
          <div className={styles.button1}>등록하기</div>
        </div>
